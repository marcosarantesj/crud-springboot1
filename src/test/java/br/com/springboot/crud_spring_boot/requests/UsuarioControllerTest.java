package br.com.springboot.crud_spring_boot.requests;
...
public class UsuarioControllerTest {
    ...
    public static void setUpClass() {
        TestWatchman.watchman.registerClass(UsuarioControllerTest.class);
    }

    @AfterClass
    public static void tearDownClass() {
        TestWatchman.watchman.createReport(UsuarioControllerTest.class);
    }
